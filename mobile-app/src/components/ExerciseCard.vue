  ...
  <div class="ex-card" @click="$emit('click')">
    ...
    <div class="ex-body">
      ...
      <div class="ex-meta">
        ...
        <span v-if="exercise.image_url" class="ex-chip photo"><i class="pi pi-image" /> photo</span>
...
.ex-chip.photo  { color: #4488FF; border-color: rgba(68,136,255,0.25); display: inline-flex; align-items: center; gap: 0.2rem; }
.ex-chip.photo .pi { font-size: 0.58rem; }
...
.ex-arrow { color: #666; font-size: 0.75rem; }
