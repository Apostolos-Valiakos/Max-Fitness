...
.sync-bar.syncing { background: var(--surface); color: #AEAEB2; }
.sync-bar.offline { background: #1A1200; color: #FFB800; }
.sync-bar.error   { background: #1A0000; color: var(--accent); }
.sync-label { flex: 1; }
.retry-btn {
  background: none; border: 1px solid rgba(74,158,255,0.4); color: var(--accent);
...
.retry-btn:active { background: rgba(74,158,255,0.1); border-color: var(--accent); }
