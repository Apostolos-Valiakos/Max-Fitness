...
.view-header {
  ...
  padding: 1rem 1rem 0.75rem; border-bottom: 1px solid var(--surface);
}
...
.client-name { font-family: 'Barlow Condensed', sans-serif; font-size: 1.4rem; font-weight: 900; color: var(--text); }
...
.tier-chip.free { color: var(--muted); border-color: var(--border); }
...
.tab { flex: 1; padding: 0.75rem; background: none; border: none; color: var(--muted); cursor: pointer; font-family: 'Barlow Condensed', sans-serif; font-size: 0.8rem; font-weight: 700; letter-spacing: 0.1em; transition: color 0.15s; }
...
.session-row {
  ...
  padding: 0.875rem 1rem; border-bottom: 1px solid var(--surface);
  cursor: pointer; transition: background 0.15s;
}
.session-row:hover { background: var(--surface); }
.sess-name { font-size: 0.9rem; color: #EBEBEB; font-weight: 500; }
.sess-meta { font-size: 0.7rem; color: var(--muted); margin-top: 0.15rem; }
.feedback-dot { color: var(--accent); font-size: 0.8rem; }

.feedback-panel {
  position: fixed; bottom: 64px; left: 0; right: 0; background: var(--bg);
  border-top: 1px solid var(--border); padding: 1rem; z-index: 50;
  box-shadow: 0 -8px 24px rgba(0,0,0,0.5);
}
.fp-header { display: flex; justify-content: space-between; align-items: flex-start; margin-bottom: 0.5rem; }
.fp-title { font-family: 'Barlow Condensed', sans-serif; font-size: 0.9rem; font-weight: 700; color: var(--text); }
.fp-date { color: var(--sub); font-weight: 400; }
.fp-close { background: none; border: none; color: var(--muted); cursor: pointer; }
.fp-stats { display: flex; gap: 1rem; font-size: 0.7rem; color: var(--muted); margin-bottom: 0.75rem; }
.feedback-textarea {
  width: 100%; background: var(--bg); border: 1px solid var(--border); color: #EBEBEB;
...
.fp-error { color: var(--accent); font-size: 0.75rem; margin-top: 0.4rem; }

/* Stats */
.stats-content { padding: 1rem; }
.kpi-row { display: grid; grid-template-columns: 1fr 1fr; gap: 0.75rem; margin-bottom: 1.25rem; }
.kpi-card { background: var(--bg); border: 1px solid var(--surface); padding: 0.875rem; }
.kpi-val { font-family: 'Barlow Condensed', sans-serif; font-size: 1.6rem; font-weight: 900; color: var(--text); }
.kpi-lbl { font-size: 0.62rem; color: var(--muted); text-transform: uppercase; letter-spacing: 0.1em; margin-top: 0.2rem; }
.section-label { font-family: 'Barlow Condensed', sans-serif; font-size: 0.65rem; font-weight: 700; color: var(--sub); letter-spacing: 0.15em; text-transform: uppercase; margin-bottom: 0.75rem; }
...
.bar-lbl { font-size: 0.55rem; color: var(--sub); }
...
.assign-btn {
  ...
  background: rgba(74,158,255,0.1); border: 1px solid rgba(74,158,255,0.3); color: var(--accent);
...
.assignment-row { display: flex; align-items: center; background: var(--bg); border: 1px solid var(--surface); padding: 0.875rem; }
.assignment-row.inactive { opacity: 0.5; }
.asgn-body { flex: 1; }
.asgn-name { font-size: 0.9rem; color: #EBEBEB; font-weight: 500; }
.asgn-meta { font-size: 0.7rem; color: var(--muted); margin-top: 0.2rem; }
.active-tag { color: #34C759; }
.inactive-tag { color: var(--muted); }
.btn-remove { background: none; border: 1px solid var(--border); color: var(--muted); padding: 0.35rem 0.5rem; cursor: pointer; font-size: 0.8rem; }
.btn-remove:hover { color: var(--accent); border-color: rgba(74,158,255,0.3); }

/* Modal */
.modal-overlay { position: fixed; inset: 0; background: rgba(0,0,0,0.7); z-index: 200; display: flex; align-items: flex-end; }
.modal { width: 100%; background: var(--bg); border-top: 1px solid var(--border); border-radius: 0; max-height: 70vh; overflow-y: auto; }
...
.plan-pick-row { padding: 0.875rem; background: var(--bg); border: 1px solid var(--surface); cursor: pointer; }
.plan-pick-row:hover { border-color: var(--accent); }
.pp-name { font-size: 0.9rem; color: #EBEBEB; font-weight: 500; }
.pp-days { font-size: 0.7rem; color: var(--muted); margin-top: 0.15rem; }
